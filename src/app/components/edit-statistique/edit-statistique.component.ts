...
@Component({
  selector: 'app-edit-statistique',
  templateUrl: './edit-statistique.component.html',
  styleUrls: ['./edit-statistique.component.css']
})
export class EditStatistiqueComponent implements OnInit {
